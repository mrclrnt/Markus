# The actions necessary for managing the Plagiarism Framework form
require 'helpers/ensure_config_helper.rb'

class AutomatedPlagiarismController < ApplicationController
	include AutomatedPlagiarismHelper
